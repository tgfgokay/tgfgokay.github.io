...
1. **Calculating provisional tax with the tariff.** Provisional tax is a flat 15%; the progressive tariff belongs to year-end. Applying the tariff on the period return makes you pay too much.
2. **Forgetting to offset the withholding.** If the 20% deducted isn’t entered on the return, you can’t get back the tax you prepaid.
3. **Leaving expenses undocumented.** Net earnings = revenue − **documented** professional expenses. An undocumented expense doesn’t reduce the tax base and makes your tax come out higher than it should.
...
I’d say that, most of the time, the only thing that changes is “writing the same numbers into the right channel.” If you’d like to design your self-employment filing and offset process together, take a look at the [Tax Returns service](/en/services/tax-returns/), and you can [reach me here](/en/contact/).
